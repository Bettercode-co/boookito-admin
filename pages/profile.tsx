      ...
      <main className="profile-page">
        <section className="relative block h-128">
          <div
            ...
            style={{
              backgroundImage: "url('/img/unsplash - 4.avif')",
            }}
          >
            <span
              id="blackOverlay"
        ...
        <section className="relative py-16 bg-slate-200">
          <div className="container mx-auto px-4">
            <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
              <div className="px-6">
                <div className=" border-red-900 flex items-center justify-between flex-wrap">
                  <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                    <div className="absolute right-2/4 -top-5 h-40 w-40">
                      <img
                        alt="..."
                        src="/img/team-2-800x800.jpg"
                        className="border shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -mr-20 lg:-mr-16 max-w-150-px"
                      />
                    </div>
                  </div>
                  <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-left lg:self-center">
                    <div className="py-6 px-3 mt-32 sm:mt-0">
                      <button
                        className="bg-slate-700 active:bg-slate-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:ml-2 mb-1 ease-linear transition-all duration-150"
                        type="button"
                      >
                        Connect
                      </button>
                ...
                <div className="text-center mt-12">
                  ...
                  <div className="text-sm leading-normal mt-0 mb-2 text-slate-400 font-bold uppercase">
                    <i className="fas fa-map-marker-alt ml-2 text-lg text-slate-400"></i>{" "}
                    Los Angeles, California
                  </div>
                  <div className="mb-2 text-slate-600 mt-10">
                    <i className="fas fa-briefcase ml-2 text-lg text-slate-400"></i>
                    Solution Manager - Creative Tim Officer
                  </div>
                  <div className="mb-2 text-slate-600">
                    <i className="fas fa-university ml-2 text-lg text-slate-400"></i>
